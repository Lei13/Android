...
public interface TagInfo extends Serializable {
	 ...
	 * 
	 * 
	 * @return the artist that performed the
	 * 
	 *         song
	 */
	...
	/**
	 * Get the name of the album upon
	 * 
	 * which the song resides
	 * 
	 * @return
	 * 
	 *         the album name
	 ...
	 * Get the track
	 * 
	 * number of this track on the album
	 * 
